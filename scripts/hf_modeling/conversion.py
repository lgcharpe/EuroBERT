...
def main(model_path: str, size: str = "300m"):
    # Convert and save model
    print(f"Converting model to Huggingface format of size {size}.")
    new_model, model_config = convert_state_dict(f"{model_path}/model.pt", architectures[size])
    ...
    save_hf_model(model_path, new_model, model_config)
    print(f"Saved converted model and sanitized tokenizer to {model_path}")
